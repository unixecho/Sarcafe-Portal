...
// Exported for /login's own button — it used to render a plain text "G"
// there while this component used the real 4-color Google mark, so the
// two doors of the same sign-in flow showed two different "G"s.
