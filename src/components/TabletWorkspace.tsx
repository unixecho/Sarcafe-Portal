...
export default function TabletWorkspace({ branches, initialBranch }: { branches: Branch[]; initialBranch: BranchSlug }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      {branch && <TabletAvailability key={branch} branchSlug={branch} />}
    </div>
  )
}
